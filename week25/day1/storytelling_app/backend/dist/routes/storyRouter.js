...
router.get('/:id/comments', auth_1.authenticate, storyController_1.getStoryComments);
router.post('/:id/comments', auth_1.authenticate, inputValidations_1.validateCommentContent, storyController_1.addComment);
