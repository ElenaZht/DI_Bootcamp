...
const usernames = []
gameInfo.forEach(g => usernames.push(`${g['username']}!`))
console.log(usernames)

//2. Create an array using forEach that contains the usernames of all players with a 
// score bigger than 5.
const winners = []
gameInfo.filter(g => g['score'] > 5).forEach(g => winners.push(g['username']))
console.log(winners)

//3. Find and display the total score of the users. (Hint: The total score is 71)
const totalScore = gameInfo.reduce((acc, curr) => acc + curr['score'], 0)
